...
public class SampleArtisticWorks{
    public static ArrayList<ArtisticWork> generate(){
        ...
        story = new ShortStory("Al Johnson","Sept. 28, 2022","Goats on the Roof","A story about the homeland in spring","English","This is a story about goats. But more importantly, it's a story about hope.","Sweden in Springtime");
        story.addComment("Jasmine Yobar","2022-10-03","I'm not from Sweden, but I sure could connect with this.");
        works.add(story);
        
        movie = new Movie("Steven Yeats","October 15, 2022","Dubliner in Paris","Seamus takes holiday in Paris and hilarity ensues.",137,"dubliner.mp4",182.43,30,"1080p");
